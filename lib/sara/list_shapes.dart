...
import 'package:kido/sara/shapeQuiz.dart';
import 'package:kido/sara/shapes.dart';

class ListShapes extends StatelessWidget {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ShapeSlider()));
                  },
                  child: Image(
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => CoVideo(
                                videopath: 'assets/shapevideo.mp4',
                                headerText: "Shapes")));
                  },
                  child: Image(
