...
class VfQuiz extends StatefulWidget {
  @override
  _VfQuizState createState() => _VfQuizState();
}

class _VfQuizState extends State<VfQuiz> {
        ...
        setState(() {
          ...
          if (finalScore == 10) {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        Result(finalScore, _resetQuiz, "vegtables&fruits")));
          }
        });
      },
      onLeave: (data) {},
