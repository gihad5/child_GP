...
import 'package:kido/wessam/co_slide.dart';
import 'package:kido/co_vedio.dart';
import 'package:kido/wessam/eng_slide.dart';

class ListCo extends StatelessWidget {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => CoSlide()));
                  },
                  child: Image(
